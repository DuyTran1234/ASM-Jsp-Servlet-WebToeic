...
@WebServlet("/InsertTestToeicQuestionController")
public class InsertTestToeicQuestionController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public InsertTestToeicQuestionController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(user != null && user.getUserTypeID() == 1) {
			...
			UpdateTestToeicDAO.insertTestToeic(request, testToeicName);
