...
@WebServlet("/DeleteAllTestToeicController")
public class DeleteAllTestToeicController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public DeleteAllTestToeicController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(user != null && user.getUserTypeID() == 1) {
			...
			UpdateTestToeicDAO.deleteAllTestToeic(testToeicName);
